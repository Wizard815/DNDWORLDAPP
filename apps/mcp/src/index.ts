...
const server = new McpServer(
  { name: "dndworldapp", version: "0.1.0" },
  {
    instructions: [
      ...
      "",
      "Two ways to write something the players must never read. For a short aside",
      "inside otherwise player-visible prose, wrap just that part in a",
      ":::secret ... ::: block, on its own lines, right in the page or section",
      "body — this is the one to reach for most often. For a whole DM-only",
      "section, create it with visibility 'dm' instead. Either way, a player-level",
      "token never receives the hidden text — not in the body, not in search.",
      "",
